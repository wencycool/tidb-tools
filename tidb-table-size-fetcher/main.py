...
# python main.py -c <cluster_name> -d <dbname> -t <table_name> --paralle=5
# 可以放在crontab中固定间隔调用，获取表的历史大小信息，方便查看趋势,比如每周日执行一次，放到crontab中则：
# /home/tidb/.bash_profile;python <path>/get_table_size.py -c <cluster_name> -d <dbname> -t <table_name> --paralle=5 -f "/home/tidb/xxx/table_size.db"
